...
This language pack contains Esperanto translations for Flarum (compatible with `2.0.0` or newer) and popular extensions. Full list of supported extensions is available below.
...
```console
composer require "flarum-lang/esperanto:@dev"
```
...
| Extension | Status |
| --- | --- |
| [`flarum/extension-manager`](https://github.com/flarum/extension-manager) | [![Translation status](https://weblate.rob006.net/widgets/flarum2/eo/flarum-extension-manager/svg-badge.svg)](https://weblate.rob006.net/projects/flarum2/flarum-extension-manager/eo/) |
